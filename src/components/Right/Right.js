...
const Right = () => {
  return (
    <div id="right">
      <div id="box-search">
        <input type="text" id="search" placeholder="Recherche Twitter" />
      ...
      <div id="might-box">
        <div id="might">
          <h1 id="might-like">Recommandation</h1>
          <Chanel
            name="ICSSA"
            src="https://www.icssa-niort.com/wp-content/uploads/2021/11/LOGO-ICSSA.png"
            userName="@icssa"
          />
          <Chanel
            name="Github"
      ...
      <div id="trends-box">
        <div id="trends">
          <div id="row">
            <h1 id="header-text">Tendance</h1>
            <AiOutlineSetting id="setting" />
          </div>
          <div id="tag-box">
            <p id="trending">1 . Sport</p>
            <h1 id="tag">#SummerBody</h1>
            <p id="tweets-tag">430.2k Tweets</p>
          </div>
          <div id="tag-box">
            <p id="trending">2 . Nourriture</p>
            <h1 id="tag">#Food</h1>
            <p id="tweets-tag">150.2k Tweets</p>
          </div>
          <div id="tag-box">
            <p id="trending">3 . Film</p>
            <h1 id="tag">#drStrange</h1>
